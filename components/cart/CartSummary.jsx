...
export default function CartSummary({ totalPrice, cartProducts }) {
  return (
    <Box className="checkout-summary" sx={{ 
        ...
        <FormControlLabel
          ...
          label={
            <Typography sx={{ fontFamily: '"Roboto", sans-serif', fontSize: "0.9rem" }}>
              Tôi đồng ý với <Link href="/terms-conditions" style={{ color: "#000", textDecoration: "underline" }}>điều khoản và điều kiện</Link>
            </Typography>
          }
        />
      </Box>
      ...
      <Box sx={{ textAlign: "center" }}>
        <Typography sx={{ fontFamily: '"Roboto", sans-serif', fontWeight: 500, mb: 1.5, fontSize: "0.9rem" }}>
          Đảm bảo thanh toán an toàn
        </Typography>
        <Box sx={{ display: "flex", justifyContent: "center", gap: 1 }}>
          <Box component="span" sx={{ width: 40, height: 25, display: "flex", alignItems: "center", justifyContent: "center" }}>
